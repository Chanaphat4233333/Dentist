class OCC_46FMC:
    def __init__(self, mb_cusp, mb_incline, mb_groove, ml_cusp, ml_incline, ml_groove, db_cusp, db_incline, db_groove, dl_cusp, dl_incline, dl_groove, threshold1, threshold2):
